...
export default function VisualReport({ report, onBack }) {
    ...
    return (
      <div className="card border-0 rounded-4 shadow-sm p-4 bg-white text-start">
        <div className="d-flex justify-content-between align-items-center mb-3">
          <h5 className="fw-bold text-dark">{report.testName}</h5>
          {onBack && (
        ...
        <div className="p-3 bg-light rounded-3 font-monospace small" style={{ whiteSpace: 'pre-wrap' }}>
  ...
  const { parameters, conclusion } = parsed;
      ...
      <div className="card border-0 rounded-4 shadow-sm overflow-hidden bg-white p-4 p-md-5 medical-report-print">
        ...
        <div className="row g-3 p-4 bg-light bg-opacity-50 rounded-4 border mb-4">
          ...
          <div className="col-md-4 col-sm-12">
            <span className="text-muted small d-block">Diagnosed & Signed By</span>
            <span className="fw-semibold text-dark"><i className="bi bi-award-fill text-warning me-1"></i>{report.uploadedBy}</span>
          </div>
        </div>
